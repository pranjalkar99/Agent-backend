...
content = Document(
    page_content = """Intangibility has certain traits to ah understand.
...
""",
metadata = {'source': 'https://onlinecourses.nptel.ac.in/noc24_hs38/unit?unit=32&lesson=34',
            'title': 'The traits Intangibility'}
)